 ...
 *
 * Accepts camelCase or snake_case fields, returns one clean shape
 * (or null when no mobile payment was made):
 *   { provider, providerLabel, senderPhone, receiptName, amount }
 * ═══════════════════════════════════════════════════════════════ */
 ...
 *
 * The backend may not always persist location/city fields reliably,
 * so every word from all available address fields is scanned for a
 * known "outside Hargeisa" city name. Any one signal is enough to
 * mark the order as outside.
 *
 * Returns:
 *   { isOutside, rawCity, cityLabel, addrLine }
 *
 *   cityLabel examples:
 *     "Inside Hargeisa"
 *     "Outside Hargeisa"
 ...
 * LOGO
 *
 * Set FRONTEND_URL=https://yourdomain.com in server/.env to use the
 * real logo at client/public/images/hero/air-collection-hero.jpg.
 * Falls back to a styled text wordmark when FRONTEND_URL is unset.
 * ═══════════════════════════════════════════════════════════════ */
const logoHtml = () => {
