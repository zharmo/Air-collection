...
const IconPinterest = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none">
    <path d="M12 2C6.48 2 2 6.48 2 12c0 3.91 2.23 7.3 5.47 9.01-.07-.64-.14-1.62.03-2.32.16-.63 1.06-4.5 1.06-4.5s-.27-.54-.27-1.34c0-1.26.73-2.2 1.64-2.2.77 0 1.14.58 1.14 1.28 0 .78-.5 1.94-.75 3.02-.21.9.45 1.63 1.32 1.63 1.59 0 2.81-1.68 2.81-4.1 0-2.14-1.54-3.64-3.73-3.64-2.54 0-4.03 1.91-4.03 3.87 0 .77.3 1.59.66 2.04.07.09.08.17.06.26-.07.27-.22.9-.25 1.03-.04.17-.12.2-.29.12-1.08-.51-1.76-2.1-1.76-3.38 0-2.74 1.99-5.26 5.74-5.26 3.01 0 5.35 2.15 5.35 5.02 0 2.99-1.88 5.4-4.5 5.4-.88 0-1.7-.46-1.98-.99l-.54 2.03c-.2.76-.73 1.7-1.09 2.28.82.25 1.69.39 2.58.39 5.52 0 10-4.48 10-10S17.52 2 12 2z"/>
  </svg>
);
          ...
          <div className="ft-grid">
            ...
            <div className="ft-col ft-col-brand">
              <div className="ft-brand-lockup">
                <div className="ft-brand-dashes" aria-hidden="true">
                  <span/><span/><span/>
                </div>
                <h2 className="ft-brand-name">AIR<br/>COLLECTION</h2>
              </div>
              <p className="ft-brand-desc">
                Premium fashion for the modern world. Consciously crafted pieces that celebrate ethereal design and sustainable luxury — every thread tells a story.
              </p>
            ...
            <div className="ft-col">
              ...
              <ul className="ft-contact">
                <li>
                  <a href="mailto:support@aircollection.com" className="ft-contact-row">
                    <span className="ft-contact-ico"><IconMail /></span>
                    support@aircollection.com
                  </a>
                </li>
                <li>
                  <a href="tel:+12345678901" className="ft-contact-row">
                    <span className="ft-contact-ico"><IconPhone /></span>
                    +1 234 567 890
                  </a>
                </li>
              </ul>
              ...
              <div className="ft-newsletter-block">
                <h3 className="ft-heading" style={{ marginBottom: '6px' }}>Newsletter</h3>
                <p className="ft-newsletter-caption">Exclusive drops & early access.</p>
                {subscribed ? (
                  ...
                  <form onSubmit={handleSubscribe} className="ft-form" noValidate>
                    <label htmlFor="ft-nl-email" className="ft-sr">Email address</label>
                    <input
                      id="ft-nl-email"
                      type="email"
                      value={email}
                      ...
                      autoComplete="email"
                    />
                    <button type="submit" className="ft-form-btn" aria-label="Subscribe">
                      <IconArrow />
                    </button>
                  </form>
                )}
        ...
        <div className="ft-bottom">
          <div className="ft-bottom-inner">
            ...
            <div className="ft-bottom-right">
              <Link href="/privacy" className="ft-blink">Privacy Policy</Link>
              <span className="ft-pipe" aria-hidden="true" />
              <Link href="/terms"   className="ft-blink">Terms of Service</Link>
              <span className="ft-pipe" aria-hidden="true" />
              <span className="ft-loc">EST. 2024 · NEW YORK — LONDON</span>
            </div>
          </div>
        </div>
...
.ft-brand-dashes span {
  display: block;
  height: 1.5px;
  background: #b8965a;
  border-radius: 99px;
}
.ft-brand-dashes span:nth-child(1) { width: 24px; }
.ft-brand-dashes span:nth-child(2) { width: 14px; opacity: 0.45; }
.ft-brand-dashes span:nth-child(3) { width: 24px; }
...
.ft-blink {
  font-size: 0.7rem; color: #3e3c36; text-decoration: none;
  font-weight: 300; letter-spacing: 0.04em;
  transition: color .2s;
}
.ft-blink:hover { color: #8a8478; }
.ft-pipe {
