...
import { FaTachometerAlt, FaUsers, FaBoxes, FaTags, FaShoppingCart, FaStar, FaSignOutAlt, FaBars, FaTimes } from 'react-icons/fa';
        ...
        <div className="admin-layout">
            ...
            <div className="container-fluid px-0">
                <div className="row g-0">
                    ...
                    <div className={`col-lg-2 px-0 ${sidebarOpen ? 'd-block' : 'd-none d-lg-block'}`}>
                        <div className="bg-white border-end vh-lg-100 p-3" style={{ minHeight: 'calc(100vh - 56px)' }}>
                    ...
                    {/* Main Content */}
                    <div className="col-lg-10 p-4" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
                        {children}
                    </div>
                </div>
            </div>
